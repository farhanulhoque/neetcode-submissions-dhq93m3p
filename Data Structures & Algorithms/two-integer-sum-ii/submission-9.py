class Solution:
    def twoSum(self, numbers: List[int], target: int) -> List[int]:
        ...
        while left < right:
            # Compute the sum of the two currently pointed elements
            ...
            # if curSum is too large — we need a smaller number
                ...
                right -= 1
            # if curSum matches target, return 1-indexed positions by adding 1 to both pointers
            else:
        ...
        #  The O(1) space constraint is the problem's way of telling you to exploit the sorted order — that's your signal to reach for Two Pointers instead of a Hash Map!