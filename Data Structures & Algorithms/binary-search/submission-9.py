class Solution:
    def search(self, nums: List[int], target: int) -> int:
        ...
        while left <= right:
            # Calculate the midpoint of the current range. This will never overflow because right is always going to be greater or equal to left. (right - left) // 2 will always be positive or 0.
