class Solution:
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
        ...
        count = {}
        # Build the empty buckets. Create n + 1 empty buckets because frequencies go from 1 to n inclusive. The index represents the frequency.
